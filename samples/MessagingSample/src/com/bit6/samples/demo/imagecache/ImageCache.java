...
package com.bit6.samples.demo.imagecache;
...
public class ImageCache {
    ...
    public static ImageCache getInstance(
        ...
        if (fragmentManager == null) {
            return getInstance(cacheParams);
        }
    ...
    // AG: 150319 - added a traditional singleton
    private static ImageCache getInstance(ImageCacheParams cacheParams) {
